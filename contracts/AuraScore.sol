...
contract AuraScore is SepoliaConfig {
    ...
    function calculateScore(externalEuint32 age, externalEuint32 dapps, bytes calldata inputProof) external {
        ...
        euint32 score = FHE.add(FHE.mul(a, FHE.asEuint32(10)), FHE.mul(d, FHE.asEuint32(25)));
